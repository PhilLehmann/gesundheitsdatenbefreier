...
$gesundheitsdatenbefreier_krankenkassen->add('atlas BKK ahlmann', '28217', 'Bremen', 'Am Kaffee-Quartier 3', 'info@abkka.de');
$gesundheitsdatenbefreier_krankenkassen->add('Audi BKK', '85057', 'Ingolstadt', 'Ettinger Str. 70', 'info@audibkk.de');
$gesundheitsdatenbefreier_krankenkassen->add('BAHN-BKK', '60486', 'Frankfurt', 'Franklinstrasse 54', 'service@bahn-bkk.de');
$gesundheitsdatenbefreier_krankenkassen->add('Bertelsmann BKK', '33335', 'Gütersloh', 'Carl-Miele-Str. 214', 'service@bertelsmann-bkk.de');
$gesundheitsdatenbefreier_krankenkassen->add('BIG direkt gesund', '10969', 'Berlin', 'Markgrafenstrasse 62', 'info@big-direkt.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Achenbach Buschhütten', '57223', 'Kreuztal', 'Siegener Str. 152', 'service@bkk-achenbach.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Akzo Nobel Bayern', '63785', 'Obernburg', 'Glanzstoffstraße', 'info@bkk-akzo.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK B. Braun | Aesculap', '34212', 'Melsungen', 'Grüne Straße 1', 'info@bkk-bba.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK BPW Bergische Achsen KG', '51674', 'Wiehl', 'Ohler Berg 1', 'info@bkk-bpw.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Deutsche Bank AG', '40212', 'Düsseldorf', 'Königsallee 60c', 'bkk.info@db.com');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Diakonie', '33617', 'Bielefeld', 'Königsweg 8', 'info@bkk-diakonie.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK EUREGIO', '52525', 'Heinsberg', 'Boos-Fremery-Straße 62', 'info@bkk-euregio.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK EVM', '56068', 'Koblenz', 'Schützenstr 80 - 82', 'info@barmenia.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK EWE', '26122', 'Oldenburg', 'Staulinie 16-17', 'info@bkk-ewe.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK exklusiv', '31275', 'Lehrte', 'Zum Blauen See 7', 'info@bkkexklusiv.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Faber-Castell & Partner', '94209', 'Regen', 'Bahnhofstraße 45', 'regen@bkk-faber-castell.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK firmus', '28237', 'Bremen', 'Gottlieb-Daimler Str. 11', 'info@bkk-firmus.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Freudenberg', '69469', 'Weinheim', 'Höhnerweg 2 - 4', 'bkk@bkk-freudenberg.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK GILDEMEISTER SEIDENSTICKER', '33649', 'Bielefeld', 'Winterstr. 49', 'info@bkkgs.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK GRILLO-WERKE AG', '47169', 'Duisburg', 'Weseler Str. 1', 'Jutta.Breithecker@bkk-grillo.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Groz-Beckert', '72458', 'Albstadt', 'Unter dem Malesfelsen 72', 'info@bkk-gb.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Herford Minden Ravensberg', '32051', 'Herford', 'Am Kleinbahnhof 5', 'info@bkk-hmr.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Herkules', '34117', 'Kassel', 'Jordanstr. 6', 'info@bkk-herkules.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK KARL MAYER', '63179', 'Obertshausen', 'Industriestraße 3', 'info@karlmayer-bkk.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Linde', '65187', 'Wiesbaden', 'Konrad-Adenauer-Ring 33', 'info@bkk-linde.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK MAHLE', '70376', 'Stuttgart', 'Pragstr. 26-46', 'info@bkk-mahle.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Melitta Plus', '32425', 'Minden', 'Marienstr. 122', 'info@bkk-melitta.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Miele', '33332', 'Gütersloh', 'Carl-Miele-Straße 29', 'info@bkk-miele.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK MTU', '88045', 'Friedrichshafen', 'Hochstraße 40', 'info@bkk-mtu.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK PFAFF', '67655', 'Kaiserslautern', 'Pirmasenser Str. 132', 'info@barmenia.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Pfalz', '67059', 'Ludwigshafen', 'Lichtenberger Str. 16', 'info@bkkpfalz.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK ProVita', '85232', 'Bergkirchen', 'Münchner Weg 5', 'info@bkk-provita.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Public', '38226', 'Salzgitter', 'Thiestrasse 15', 'service@bkk-public.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Rieker.RICOSTA.Weisser', '78532', 'Tuttlingen', 'Stockacher Str. 4-6', 'info@bkk-rrw.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK RWE', '29225', 'Celle', 'Welfenallee 32', 'info@bkkrwe.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Salzgitter', '38226', 'Salzgitter', 'Thiestrasse 15', 'service@bkk-salzgitter.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Scheufelen', '73230', 'Kirchheim', 'Schöllkopfstr. 65', 'info@bkk-scheufelen.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Schwarzwald-Baar-Heuberg', '78647', 'Trossingen', 'Löhrstraße 45', 'info@bkk-sbh.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK STADT AUGSBURG', '86153', 'Augsburg', 'Willy-Brandt-Platz 1', 'info@bkk-stadt-augsburg.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Technoform', '37079', 'Göttingen', 'August-Spindler-Straße 1', 'willkommen@bkk-technoform.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Textilgruppe Hof', '95028', 'Hof', 'Fabrikzeile 21', 'info@BKK-Textilgruppe-Hof.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK VDN', '58239', 'Schwerte', 'Rosenweg 15', 'info@bkk-vdn.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK VerbundPlus', '80333', 'München', 'Karloninenplatz 5', 'info@bkkvp.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Verkehrsbau Union (VBU)', '10969', 'Berlin', 'Lindenstraße 67', 'info@bkk-vbu.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Werra-Meissner', '37269', 'Eschwege', 'Straßburger Str. 5', 'info@bkk-wm.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Wirtschaft & Finanzen', '34212', 'Melsungen', 'Bahnhofstr. 19', 'kundenmanagement@bkk-wf.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK Würth', '74653', 'Künzelsau', 'Gartenstraße 11', 'info@bkk-wuerth.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK ZF & Partner', '56068', 'Koblenz', 'Am Wöllershof 12', 'koblenz@bkk-zf-partner.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK_DürkoppAdler', '33605', 'Bielefeld', 'Sieghorster Str. 66', 'info@bkk-da.de');
$gesundheitsdatenbefreier_krankenkassen->add('BKK24', '31683', 'Obernkirchen', 'Sülbecker Brand 1', 'info@bkk24.de');
$gesundheitsdatenbefreier_krankenkassen->add('BMW BKK', '84130', 'Dingolfing', 'Mengkofener Str.  6', 'Informationen@bmwbkk.de');
$gesundheitsdatenbefreier_krankenkassen->add('Bosch BKK', '70469', 'Stuttgart', 'Kruppstr. 19', 'info@Bosch-BKK.de');
$gesundheitsdatenbefreier_krankenkassen->add('Continentale Betriebskrankenkasse', '22335', 'Hamburg', 'Sengelmannstrasse 120', 'kundenservice@continentale-bkk.de');
$gesundheitsdatenbefreier_krankenkassen->add('Debeka BKK', '56072', 'Koblenz', 'Im Metternicher Feld 40', 'info@debeka-bkk.de');
$gesundheitsdatenbefreier_krankenkassen->add('DIE BERGISCHE KRANKENKASSE', '42719', 'Solingen', 'Heresbachstr. 29', 'info@die-bergische-kk.de');
$gesundheitsdatenbefreier_krankenkassen->add('Die Schwenninger Betriebskrankenkasse', '78056', 'Villingen-Schwenningen', 'Spittelstr. 50', 'Info@Die-Schwenninger.de');
$gesundheitsdatenbefreier_krankenkassen->add('energie-Betriebskrankenkasse', '30159', 'Hannover', 'Lange Laube 6', 'info@energie-bkk.de');
$gesundheitsdatenbefreier_krankenkassen->add('Ernst & Young BKK', '80636', 'München', 'Arnulfstr. 59', 'info@ey-bkk.de');
$gesundheitsdatenbefreier_krankenkassen->add('Heimat Krankenkasse', '33602', 'Bielefeld', 'Herforder Str. 23', 'info@heimat-krankenkasse.de');
$gesundheitsdatenbefreier_krankenkassen->add('IKK gesund plus', '39124', 'Magdeburg', 'Umfassungsstraße 85', 'info@ikk-gesundplus.de');
$gesundheitsdatenbefreier_krankenkassen->add('IKK Nord', '19061', 'Schwerin', 'Ellerried 1', 'mail@ikk-nord.de');
$gesundheitsdatenbefreier_krankenkassen->add('IKK Südwest', '66111', 'Saarbrücken', 'Berliner Promenade 1', 'info@ikk-suedwest.de');
...
$gesundheitsdatenbefreier_krankenkassen->add('Allianz Private Krankenversicherungs-Aktiengesellschaft', '85774', 'Unterföhring', 'Dieselstraße 6-8', 'info@allianz.de');
$gesundheitsdatenbefreier_krankenkassen->add('ALTE OLDENBURGER Krankenversicherung AG', '49377', 'Vechta', 'Alte-Oldenburger-Platz 1', 'info@alte-oldenburger.de');
$gesundheitsdatenbefreier_krankenkassen->add('ALTE OLDENBURGER Krankenversicherung von 1927 Versicherungsverein auf Gegenseitigkeit', '49377', 'Vechta', 'Alte-Oldenburger-Platz 1', 'info@alte-oldenburger.de');
$gesundheitsdatenbefreier_krankenkassen->add('ARAG Krankenversicherungs-Aktiengesellschaft', '81829', 'München', 'Hollerithstraße 11', 'msc@arag.de');
$gesundheitsdatenbefreier_krankenkassen->add('Augenoptiker Ausgleichskasse VVaG (AKA)', '44225', 'Dortmund', 'Generationenweg 4', '');
$gesundheitsdatenbefreier_krankenkassen->add('AXA Krankenversicherung Aktiengesellschaft', '51067', 'Köln', 'Colonia Allee 10-20', 'info@axa.de');
...
$gesundheitsdatenbefreier_krankenkassen->add('Central Krankenversicherung Aktiengesellschaft', '50670', 'Köln', 'Hansaring 40 - 50', 'info@central.de');
...
$gesundheitsdatenbefreier_krankenkassen->add('Debeka Krankenversicherungsverein auf Gegenseitigkeit Sitz Koblenz am Rhein', '56073', 'Koblenz am Rhein', 'Ferdinand-Sauerbruch-Straße 18', 'kundenservice@debeka.de');
$gesundheitsdatenbefreier_krankenkassen->add('DEVK Krankenversicherungs-Aktiengesellschaft', '50735', 'Köln', 'Riehler Straße 190', '');
$gesundheitsdatenbefreier_krankenkassen->add('DKV Deutsche Krankenversicherung Aktiengesellschaft', '50933', 'Köln', 'Aachener Straße 300', 'service@dkv.com');
$gesundheitsdatenbefreier_krankenkassen->add('ENVIVAS Krankenversicherung Aktiengesellschaft', '50670', 'Köln', 'Gereonswall 68', '');
$gesundheitsdatenbefreier_krankenkassen->add('ERGO Krankenversicherung AG', '90762', 'Fürth', 'Bay', 'Nürnberger Straße 91-95', 'info@ergodirekt.de');
...
$gesundheitsdatenbefreier_krankenkassen->add('HanseMerkur Krankenversicherung AG', '20354', 'Hamburg', 'Siegfried-Wedells-Platz 1', 'info@hansemerkur.de');
$gesundheitsdatenbefreier_krankenkassen->add('HanseMerkur Krankenversicherung auf Gegenseitigkeit', '20354', 'Hamburg', 'Siegfried-Wedells-Platz 1', 'info@hansemerkur.de');
$gesundheitsdatenbefreier_krankenkassen->add('HanseMerkur Speziale Krankenversicherung AG', '20354', 'Hamburg', 'Siegfried-Wedells-Platz 1', 'info@hansemerkur.de');
$gesundheitsdatenbefreier_krankenkassen->add('HUK-COBURG-Krankenversicherung AG', '96450', 'Coburg', 'Bahnhofsplatz', 'Info@HUK-COBURG.de');
...
$gesundheitsdatenbefreier_krankenkassen->add('LVM Krankenversicherungs-AG', '48151', 'Münster', 'Kolde-Ring 21', 'info@lvm.de');
...
$gesundheitsdatenbefreier_krankenkassen->add('ottonova Krankenversicherung AG', '80333', 'München', 'Ottostraße 4', 'helpdesk@ottonova.de');
...
$gesundheitsdatenbefreier_krankenkassen->add('R+V Krankenversicherung Aktiengesellschaft', '65189', 'Wiesbaden', 'Raiffeisenplatz 1', 'ruv@ruv.de');
